	...
	<body>
		<div id="root">
			...
			<section id="container">
				<form name="readForm" role="readForm" role="form" method="post">
					...
					<tbody>
						...
						<tr>
							<td>
								...
								<textarea id="content" name="content" rows="30" cols="100" readonly="readonly"><c:out value="${read.content.trim()}" /></textarea>
							</td>
						</tr>
						<tr>
							<td>
